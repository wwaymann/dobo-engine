...
from kernel.services.geometry_request_engine import (
    GeometryRequestEngine,
)
...
def main() -> None:
    ...
    if result.count != 1:
        raise RuntimeError(
            "Expected one generated solid."
        )

    print()
    print("DOBO Geometry Request Engine")
    print("----------------------------")
    print(
        "Operation:",
