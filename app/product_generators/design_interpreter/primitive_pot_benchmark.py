...
CASES = (
    ...
    {"id":"05_sphere","label":"Esfera","expected_morphology":{"spherical"},"expected_semantic":{"spherical","sphere"},"prompt":"Haz una maceta funcional esférica, truncada por una abertura superior, hueca y con drenaje inferior. Sin texto, sin decoración y sin patrones."},
