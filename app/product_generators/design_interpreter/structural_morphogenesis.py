...
class StructuralMorphogenesisResolver:
    ...
    def resolve(cls, program: DesignSemanticProgram, grammar: DesignGrammarPlan) -> StructuralMorphologyPlan:
        ...
        # Macroblock D profiles are activated only by explicit visual-DNA tags.
        # This preserves every accepted A/B/C regression while allowing the new
        # benchmark to demand genuinely different body construction.
